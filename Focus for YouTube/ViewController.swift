...
var blockableElements: [BlockableElement] = [
    ...
    BlockableElement(withName: "Thumbnail Images", andRule: BlockerRule(triggers: [.urlFilter: "https?://(www.)?youtube.com.*"], actionType: .CSSDisplayNone, selector: "#dismissible > ytd-thumbnail, #media-container, #thumbnail"), isBlockedByDefault: false),
